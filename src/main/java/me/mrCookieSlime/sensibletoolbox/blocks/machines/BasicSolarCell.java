...
public class BasicSolarCell extends BaseSTBMachine implements LightMeterHolder {
    ...
    private String blueLight = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmUxZjQ5MDFhYjc4ZmQxNjk5NmM0ZjgzMjgxMmE5M2RiZjI1ZTVkNDI4ODdlOWRkYTgzODQ3ODIxZWQ1OTcifX19";
    private String grayLight = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvOWM5OTFhMzQ1M2RmYjNhZTc0NDU2NWQ5ZjM0NzExNTgwMjRlMTE3ZDJjOWJhZDBjNjNkMjQ5MTEzMzFjY2VhIn19fQ==";

    public BasicSolarCell() {
        pvCellLife = 0;
        setChargeDirection(ChargeDirection.CELL);
        skulltexture = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvY2Q5ZjNjYzdkNmJiYjYzYWM1ZDM4ZjM2NWU3NTM3ZTM3YjU4NjU3M2RjODc4ZWUxZWU2OGM2YThmYjkzZjIifX19";
    }
	...
	private void drawPVLayer(Block b) {
        ...
        if (b.getLocation().add(0, -1, 0).equals(this.getLocation())) {
            String MwCol = pvCellLife > 0 ? blueLight : grayLight;
            try {
                b.setType(Material.SKULL);
                b.setData((byte) 0x1); // Floor
                CustomSkull.setSkull(b, MwCol);
            } catch (Exception e) {
