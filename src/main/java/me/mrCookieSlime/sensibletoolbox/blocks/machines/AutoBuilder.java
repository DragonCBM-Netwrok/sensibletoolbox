...
public class AutoBuilder extends BaseSTBMachine {
    ...
    public AutoBuilder() {
        super();
        skulltexture = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYmRhODZjOWYyMWNjNWFlMjg4NDc4OTBlYzFiNzhmNDY4MWUxN2M3MWQyNDNjYjJiYWZlMjMzZmYxMjA3MSJ9fX0=";
    ...
    public Recipe getRecipe() {
        ...
        recipe.setIngredient('C', SensibleToolboxPlugin.getSTBItemMaterialData(ic));
