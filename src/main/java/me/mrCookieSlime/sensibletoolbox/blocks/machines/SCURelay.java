...
public class SCURelay extends BatteryBox {
    ...
    public SCURelay() {
        super();
        skulltexture = "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTFiOGZkYTQzMTFmNzQ3M2JjOTQ4ZmI1NWExNzI0YzUzYWZmYTZmYmEzM2U3NWQ0MTM2ZWYwM2ZhOThhOGMifX19";
    }
    ...
    public Recipe getRecipe() {
        ...
        recipe.addIngredient(SensibleToolboxPlugin.getSTBItemMaterialData(usr));
        recipe.addIngredient(SensibleToolboxPlugin.getSTBItemMaterialData(usr));
        return recipe;
    }
